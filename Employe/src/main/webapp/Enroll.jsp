...
<img src="https://www.oasdom.com/wp-content/uploads/2018/01/oasdom.com-6-free-logo-design-online.jpg" >
	...
	<form method="post" style="width: 100%;" >
	  ...
	  <div class="mb-3 form1">
		...
		<input  class="form-control" type="text" name="firstName" minlength="3" maxlength="20" >
		<span class="error" style="display:none;">Please enter a valid first name (3-20 characters).</span><br /><br />
		 </div>
		<div class="mb-3 form1">
		<label style="width:27%" for="lastName"><b>Last Name :</b></label>
		<input  class="form-control" type="text" name="lastName" minlength="3" maxlength="20" >
		<span class="error" style="display:none;">Please enter a valid last name (3-20 characters).</span><br /><br />
		 </div>
		...
		<span class="error" style="display:none;">Please select the gender</span><br /><br />
		</div>
		
		<div class="mb-3 form1">
		<label style="width:27%" for="birthday"><b>Date of Birth:</b></label>
		 <input type="date" id="dob" name="birthday" onchange="calculateAge()"> 
		 <span class="error" style="display:none;">Please enter valid date of birth</span><br /><br />
		 </div><br/>
		 <div class="mb-3 form1">
		...
		<span class="error" style="display:none;">Please enter a valid phone number(10 characters).</span><br /><br />
		</div>
		...
		<span class="error" style="display:none;">Please enter Local Address</span><br /><br />
		...
		<span class="error" style="display:none;">Please enter Permanent Address</span><br /><br />
	    </div>
		...
		<select id="department" name="department" onchange="updateDepartments()">
				...
				<span class="error" style="display:none;">Please select the department</span><br /><br />
		</div>
		...
		<span class="error" style="display:none;">Please  select the Job Title</span><br /><br />
		</div><br/>
		...
		<select id="salary" name="salary">
				...
				<span class="error" style="display:none;">Please  select Salary</span><br /><br />
				</div>
				
		<div class="mb-3 form1">
		<label style="width:27%" for="beginDate"><b>Begin Date:<b></b></label>
		<input class="form-control" type="date" id="beginDate" name="beginDate" onchange="updateUI()" ><br/><br/>
		<span class="error" style="display:none;">Please  select the Begin Date</span><br /><br />
		</div>
		...
		<span class="error" style="display:none;">Please  select Status</span><br /><br />
		</div>
		
		<div class="mb-3 form1">
		<label style="width:27%" for="endDate">End Date:</label>
		...
		<span class="error" style="display:none;">Please enter Qualifications</span><br /><br />
		</div>
		
		<div class="mb-3 form1">
		<label style="width:27%" for="skills"><b>Skills:</b></label>
		<input  class="form-control" type="text" name="skills" ><br/><br/>
		 <span class="error" style="display:none;">Please enter the Skills</span><br /><br />
		</div>
		...
		<span class="error" style="display:none;">Please enter the valid E-Mail id</span><br /><br />
		</div>
		...
		<span class="error" style="display:none;">Please enter the valid password</span><br /><br />
		</div>
